...
Let's start by definining a hyperplane. In _p_-dimensional space a hyperplane is a flat affine subspace of _p_-1. Figure \@ref(fig:svmSeparatingHyperplanes) shows three different hyperplanes and objects of two different classes. H2 and H3 are two of many possible hyperplanes that separate the two classes of observations. A separating hyperplane forms a natural linear decision boundary, classifying new objects according to which side of the line they are located.
