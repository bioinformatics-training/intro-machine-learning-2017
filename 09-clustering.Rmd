...
```{r clusterTypes, fig.cap='Example clusters. **A**, *blobs*; **B**, *aggregation* [@Gionis2007]; **C**, *noisy moons*; **D**, *noisy circles*; **E**, *D31* [@Veenman2002]; **F**, *no structure*.', out.width='80%', fig.asp=.9, fig.align='center', echo=F}
library(ggplot2)
library(GGally)
...
```{r hclustToyData, fig.cap='Hierarchical clustering of toy data-sets. ', out.width='80%', fig.asp=0.9, fig.align='center',echo=T}
