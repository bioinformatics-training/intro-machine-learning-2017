...
```{r DBSCAN-illustration, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Graphical representation of the DBSCAN algorithm."}
knitr::include_graphics("figures/DBSCAN-Illustration.svg")
```
