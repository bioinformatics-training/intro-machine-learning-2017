...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{42}\NormalTok{)}
\NormalTok{res <-}\StringTok{ }\KeywordTok{kmeans}\NormalTok{(}\KeywordTok{t}\NormalTok{(e), }\DecValTok{7}\NormalTok{, }\DataTypeTok{nstart=}\DecValTok{10}\NormalTok{)}
...
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{col=}\KeywordTok{brewer.pal}\NormalTok{(}\DecValTok{7}\NormalTok{,}\StringTok{"Dark2"}\NormalTok{)[res$cluster], }
             \DataTypeTok{shape=}\KeywordTok{c}\NormalTok{(}\DecValTok{49}\NormalTok{:}\DecValTok{55}\NormalTok{)[res$cluster], }\DataTypeTok{size=}\DecValTok{5}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
