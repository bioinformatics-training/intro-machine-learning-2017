...
The imbalance between the number of variables and the number of observatins is often referred to as large p, small n, Further to this, the presence of noise in the system means that statistical analyses can be difficult.
