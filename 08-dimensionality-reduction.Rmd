...
A key goal when dealing with datasets of these magnitude is the identification of subpopulations of cells that may have gone undetected in bulk measurements ; another key goal lies in the identification the progression inherent to the dataset, by putting the cells into a particular ordering.
\cite{}
