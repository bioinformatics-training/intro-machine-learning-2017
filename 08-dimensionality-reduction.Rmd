...
Systems level measurments of gene expression such as those generated from collections of microarrays and RNA-sequencing experiments are increasingly used to understand complex biologial systems. In the past, studies based on bulk measurments have tended to provide observations for many variables (expression of many genes) but relatively few samples e.g., time points or conditions. This imbalance between the number of variables and the number of observatins is referred to as large p, small n. Further to this, the presence of noise in the system means that statistical analyses can be difficult.
